...
// 
//--------------------
class AC_DECO_CONDITION_RESEARCH_RESTORATION : public BT_DECO_CONDITION {
public:
    AC_DECO_CONDITION_RESEARCH_RESTORATION(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchRestoration(void* data);
};
//----------