...
// 
//--------------------
class AC_DECO_CONDITION_RESEARCH_CADUCEUSREACTOR : public BT_DECO_CONDITION {
public:
    AC_DECO_CONDITION_RESEARCH_CADUCEUSREACTOR(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchCaduceusreactor(void* data);
};
//----------