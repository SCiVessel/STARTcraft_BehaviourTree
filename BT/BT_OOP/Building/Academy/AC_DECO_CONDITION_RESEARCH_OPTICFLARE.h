...
// 
//--------------------
class AC_DECO_CONDITION_RESEARCH_OPTICFLARE : public BT_DECO_CONDITION {
public:
    AC_DECO_CONDITION_RESEARCH_OPTICFLARE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchOpticflare(void* data);
};
//----------