...
// 
//--------------------
class BA_DECO_CONDITION_NOT_ENOUGH_FIREBAT: public BT_DECO_CONDITION {
public:
    BA_DECO_CONDITION_NOT_ENOUGH_FIREBAT(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughFirebat(void *data);
