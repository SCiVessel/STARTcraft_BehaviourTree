...
// 
//--------------------
class BA_DECO_CONDITION_NOT_ENOUGH_MEDIC: public BT_DECO_CONDITION {
public:
    BA_DECO_CONDITION_NOT_ENOUGH_MEDIC(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughMedic(void *data);
