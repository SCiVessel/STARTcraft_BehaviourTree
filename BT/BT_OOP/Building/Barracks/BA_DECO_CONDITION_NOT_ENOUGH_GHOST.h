...
// 
//--------------------
class BA_DECO_CONDITION_NOT_ENOUGH_GHOST : public BT_DECO_CONDITION {
public:
    BA_DECO_CONDITION_NOT_ENOUGH_GHOST(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughGhost(void* data);
