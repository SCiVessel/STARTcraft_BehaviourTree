...
// 
//--------------------
class CC_DECO_CONDITION_NOT_ENOUGH_COMSATSTATION : public BT_DECO_CONDITION {
public:
    CC_DECO_CONDITION_NOT_ENOUGH_COMSATSTATION(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughComsatStation(void *data);
