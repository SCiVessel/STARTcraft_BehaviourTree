...
// 
//--------------------
class EB_DECO_CONDITION_UPGRADE_INFANTRYWEAPONS_LV1 : public BT_DECO_CONDITION {
public:
    EB_DECO_CONDITION_UPGRADE_INFANTRYWEAPONS_LV1(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeInfantryweaponslv1(void* data);
};
//----------