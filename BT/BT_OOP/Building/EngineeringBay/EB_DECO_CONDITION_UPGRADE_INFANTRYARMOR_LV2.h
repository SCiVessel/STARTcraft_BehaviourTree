...
// 
//--------------------
class EB_DECO_CONDITION_UPGRADE_INFANTRYARMOR_LV2 : public BT_DECO_CONDITION {
public:
    EB_DECO_CONDITION_UPGRADE_INFANTRYARMOR_LV2(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeInfantryarmorlv2(void* data);
};
//----------