...
// 
//--------------------
class EB_DECO_CONDITION_UPGRADE_INFANTRYARMOR_LV1 : public BT_DECO_CONDITION {
public:
    EB_DECO_CONDITION_UPGRADE_INFANTRYARMOR_LV1(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeInfantryarmorlv1(void* data);
};
//----------