...
// 
//--------------------
class AR_DECO_CONDITION_UPGRADE_VEHICLEARMOR_LV3 : public BT_DECO_CONDITION {
public:
    AR_DECO_CONDITION_UPGRADE_VEHICLEARMOR_LV3(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeVehiclearmorlv3(void* data);
};
//----------