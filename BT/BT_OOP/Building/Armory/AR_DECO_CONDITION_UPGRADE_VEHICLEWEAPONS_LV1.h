...
// 
//--------------------
class AR_DECO_CONDITION_UPGRADE_VEHICLEWEAPONS_LV1 : public BT_DECO_CONDITION {
public:
    AR_DECO_CONDITION_UPGRADE_VEHICLEWEAPONS_LV1(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeVehicleweaponslv1(void* data);
};
//----------