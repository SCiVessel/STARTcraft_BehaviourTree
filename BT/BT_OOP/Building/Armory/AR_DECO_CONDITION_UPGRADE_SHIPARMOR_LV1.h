...
// 
//--------------------
class AR_DECO_CONDITION_UPGRADE_SHIPARMOR_LV1 : public BT_DECO_CONDITION {
public:
    AR_DECO_CONDITION_UPGRADE_SHIPARMOR_LV1(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeShiparmorlv1(void* data);
};
//----------