...
// 
//--------------------
class AR_DECO_CONDITION_UPGRADE_SHIPARMOR_LV3 : public BT_DECO_CONDITION {
public:
    AR_DECO_CONDITION_UPGRADE_SHIPARMOR_LV3(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeShiparmorlv3(void* data);
};
//----------