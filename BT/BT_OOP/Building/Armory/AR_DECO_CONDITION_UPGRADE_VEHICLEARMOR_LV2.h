...
// 
//--------------------
class AR_DECO_CONDITION_UPGRADE_VEHICLEARMOR_LV2 : public BT_DECO_CONDITION {
public:
    AR_DECO_CONDITION_UPGRADE_VEHICLEARMOR_LV2(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canUpgradeVehiclearmorlv2(void* data);
};
//----------