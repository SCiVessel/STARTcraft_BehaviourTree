...
// 
//--------------------
class SF_DECO_CONDITION_RESEARCH_EMPSHOCKWAVE : public BT_DECO_CONDITION {
public:
    SF_DECO_CONDITION_RESEARCH_EMPSHOCKWAVE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchEmpshockwave(void* data);
};
//----------