...
// 
//--------------------
class SF_DECO_CONDITION_NOT_ENOUGH_PHYSICSLAB : public BT_DECO_CONDITION {
public:
    SF_DECO_CONDITION_NOT_ENOUGH_PHYSICSLAB(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughPhysicsLab(void *data);
