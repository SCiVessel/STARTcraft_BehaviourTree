...
// 
//--------------------
class SF_DECO_CONDITION_NOT_ENOUGH_COVERTOPS : public BT_DECO_CONDITION {
public:
    SF_DECO_CONDITION_NOT_ENOUGH_COVERTOPS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughCovertOps(void *data);
