...
// 
//--------------------
class CO_DECO_CONDITION_RESEARCH_PERSONALCLOAKING : public BT_DECO_CONDITION {
public:
    CO_DECO_CONDITION_RESEARCH_PERSONALCLOAKING(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchPersonalcloaking(void* data);
};
//----------