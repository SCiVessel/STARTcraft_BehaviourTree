...
// 
//--------------------
class CO_DECO_CONDITION_RESEARCH_LOCKDOWN : public BT_DECO_CONDITION {
public:
    CO_DECO_CONDITION_RESEARCH_LOCKDOWN(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchLockdown(void* data);
};
//----------