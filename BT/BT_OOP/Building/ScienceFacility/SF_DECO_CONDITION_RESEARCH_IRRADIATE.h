...
// 
//--------------------
class SF_DECO_CONDITION_RESEARCH_IRRADIATE : public BT_DECO_CONDITION {
public:
    SF_DECO_CONDITION_RESEARCH_IRRADIATE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchIrradiate(void* data);
};
//----------