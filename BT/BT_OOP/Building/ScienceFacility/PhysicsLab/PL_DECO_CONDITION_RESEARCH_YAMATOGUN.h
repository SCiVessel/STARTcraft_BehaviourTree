...
// 
//--------------------
class PL_DECO_CONDITION_RESEARCH_YAMATOGUN : public BT_DECO_CONDITION {
public:
    PL_DECO_CONDITION_RESEARCH_YAMATOGUN(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchYamatogun(void* data);
};
//----------