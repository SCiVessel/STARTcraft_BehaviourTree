...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_CONTROLTOWER : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_CONTROLTOWER(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughControlTower(void *data);
