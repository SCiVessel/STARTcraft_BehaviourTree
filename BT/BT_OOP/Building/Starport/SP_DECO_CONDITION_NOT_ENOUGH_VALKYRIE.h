...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_VALKYRIE : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_VALKYRIE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughValkyrie(void* data);
