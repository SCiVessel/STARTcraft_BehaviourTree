...
// 
//--------------------
class CT_DECO_CONDITION_RESEARCH_CLOAKINGFIELD : public BT_DECO_CONDITION {
public:
    CT_DECO_CONDITION_RESEARCH_CLOAKINGFIELD(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchCloakingfield(void* data);
};
//----------