...
// 
//--------------------
class CT_DECO_CONDITION_RESEARCH_APOLLOREACTOR : public BT_DECO_CONDITION {
public:
    CT_DECO_CONDITION_RESEARCH_APOLLOREACTOR(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchApolloreactor(void* data);
};
//----------