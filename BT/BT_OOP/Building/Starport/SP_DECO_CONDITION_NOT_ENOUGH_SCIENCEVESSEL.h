...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_SCIENCEVESSEL : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_SCIENCEVESSEL(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughSciencevessel(void* data);
