...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_WRAITH : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_WRAITH(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughWraith(void* data);
