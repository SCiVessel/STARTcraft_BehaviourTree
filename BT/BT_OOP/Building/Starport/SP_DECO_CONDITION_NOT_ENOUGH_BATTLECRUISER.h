...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_BATTLECRUISER : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_BATTLECRUISER(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughBattlecruiser(void* data);
