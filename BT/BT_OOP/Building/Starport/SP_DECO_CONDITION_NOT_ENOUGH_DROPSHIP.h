...
// 
//--------------------
class SP_DECO_CONDITION_NOT_ENOUGH_DROPSHIP : public BT_DECO_CONDITION {
public:
    SP_DECO_CONDITION_NOT_ENOUGH_DROPSHIP(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughDropship(void* data);
