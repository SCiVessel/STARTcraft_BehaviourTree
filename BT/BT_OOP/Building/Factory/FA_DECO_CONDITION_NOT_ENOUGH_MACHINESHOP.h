...
// 
//--------------------
class FA_DECO_CONDITION_NOT_ENOUGH_MACHINESHOP : public BT_DECO_CONDITION {
public:
    FA_DECO_CONDITION_NOT_ENOUGH_MACHINESHOP(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughMachineShop(void *data);
