...
// 
//--------------------
class MS_DECO_CONDITION_RESEARCH_IONTHRUSTERS : public BT_DECO_CONDITION {
public:
    MS_DECO_CONDITION_RESEARCH_IONTHRUSTERS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchIonthrusters(void* data);
};
//----------