...
// 
//--------------------
class MS_DECO_CONDITION_RESEARCH_CHARONBOOSTERS : public BT_DECO_CONDITION {
public:
    MS_DECO_CONDITION_RESEARCH_CHARONBOOSTERS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchCharonboosters(void* data);
};
//----------