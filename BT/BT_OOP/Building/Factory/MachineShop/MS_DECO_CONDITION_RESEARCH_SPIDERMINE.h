...
// 
//--------------------
class MS_DECO_CONDITION_RESEARCH_SPIDERMINE : public BT_DECO_CONDITION {
public:
    MS_DECO_CONDITION_RESEARCH_SPIDERMINE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool canResearchSpidermine(void* data);
};
//----------