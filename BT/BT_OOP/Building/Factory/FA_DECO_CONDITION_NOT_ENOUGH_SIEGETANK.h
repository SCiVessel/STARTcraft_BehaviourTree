...
// 
//--------------------
class FA_DECO_CONDITION_NOT_ENOUGH_SIEGETANK: public BT_DECO_CONDITION {
public:
    FA_DECO_CONDITION_NOT_ENOUGH_SIEGETANK(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughSiegetank(void *data);
