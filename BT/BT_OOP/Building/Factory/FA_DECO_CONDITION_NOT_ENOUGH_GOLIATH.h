...
// 
//--------------------
class FA_DECO_CONDITION_NOT_ENOUGH_GOLIATH : public BT_DECO_CONDITION {
public:
    FA_DECO_CONDITION_NOT_ENOUGH_GOLIATH(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughGoliath(void* data);
