...
// 
//--------------------
class FA_DECO_CONDITION_NOT_ENOUGH_VULTURE: public BT_DECO_CONDITION {
public:
    FA_DECO_CONDITION_NOT_ENOUGH_VULTURE(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughVulture(void *data);
