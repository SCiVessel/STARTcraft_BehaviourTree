...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_SCIENCEFACILITY : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_SCIENCEFACILITY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughScienceFacility(void *data);
