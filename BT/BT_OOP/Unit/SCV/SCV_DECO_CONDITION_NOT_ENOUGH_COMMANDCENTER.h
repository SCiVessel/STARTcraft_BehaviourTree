...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_COMMANDCENTER : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_COMMANDCENTER(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughCommandCenter(void *data);
