...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_ARMORY: public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_ARMORY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughArmory(void *data);
