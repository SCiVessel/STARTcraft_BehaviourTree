...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_REFINERY: public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_REFINERY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughRefinery(void *data);
