...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_ENGINEERINGBAY : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_ENGINEERINGBAY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughEngineeringBay(void *data);
