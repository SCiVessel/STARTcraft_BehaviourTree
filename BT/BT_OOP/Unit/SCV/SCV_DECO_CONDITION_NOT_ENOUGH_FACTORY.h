...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_FACTORY : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_FACTORY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughFactory(void *data);
