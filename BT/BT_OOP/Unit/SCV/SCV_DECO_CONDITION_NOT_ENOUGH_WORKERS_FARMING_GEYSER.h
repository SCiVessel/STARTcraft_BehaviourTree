...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_GEYSER : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_GEYSER(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughWorkersFarmingGeyser(void *data);
