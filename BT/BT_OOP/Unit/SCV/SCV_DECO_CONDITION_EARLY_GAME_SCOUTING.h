...
// 
//--------------------
class SCV_DECO_CONDITION_EARLY_GAME_SCOUTING : public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_EARLY_GAME_SCOUTING(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool EarlyGameScouting(void *data);
