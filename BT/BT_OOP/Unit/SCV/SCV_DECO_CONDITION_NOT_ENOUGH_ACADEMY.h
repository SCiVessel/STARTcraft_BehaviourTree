...
// 
//--------------------
class SCV_DECO_CONDITION_NOT_ENOUGH_ACADEMY: public BT_DECO_CONDITION {
public:
    SCV_DECO_CONDITION_NOT_ENOUGH_ACADEMY(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughAcademy(void *data);
