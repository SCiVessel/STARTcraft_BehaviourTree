...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_SUPPLY: public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_NOT_ENOUGH_SUPPLY(std::string name, BT_NODE* parent, int thresholdSupply);
    std::string GetDescription() override;

    static bool IsThereNotEnoughSupply(void *data);
