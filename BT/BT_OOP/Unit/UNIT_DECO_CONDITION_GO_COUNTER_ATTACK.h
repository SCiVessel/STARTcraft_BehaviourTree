...
// 
//--------------------
class UNIT_DECO_CONDITION_GO_COUNTER_ATTACK: public BT_DECO_CONDITION {
public:
    UNIT_DECO_CONDITION_GO_COUNTER_ATTACK(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool goCounterAttack(void *data);
