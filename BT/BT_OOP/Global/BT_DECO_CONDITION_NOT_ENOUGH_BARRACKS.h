...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_BARRACKS: public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_NOT_ENOUGH_BARRACKS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughBarracks(void *data);
